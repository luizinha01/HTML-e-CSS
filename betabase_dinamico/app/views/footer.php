...
<footer>
            <div class="container">
                <div class="row">
                    <div class="col-md-2"><a href="?i=home"><img id="logo" src="app/img/logo.svg"></a></div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p>© 2017 betabase | Todos os direitos reservados. Construido por <a href="#">Luizinha mil grau</a>.</p>
                    </div>
                </div>
            </div>
            <!-- jQuery -->
